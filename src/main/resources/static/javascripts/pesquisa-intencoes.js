...
Compraki.IntencaoCompraComboModelo = (function() {
	...
	function onBuscarModelos(modelos) {
		...
		modelos.forEach(function(modelo) {
			options.push('<option value="' + modelo.codigo + '">'
...
$(function() {
	...
	var intencaoCompraComboModelo = new Compraki.IntencaoCompraComboModelo(
			comboMarca);
	...
	var intencaoCompraComboCidade = new Compraki.IntencaoCompraComboCidade(
			comboUf);
